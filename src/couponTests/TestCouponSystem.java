...
public static void main(String[] args) {
	 ...
	 * 		
	 * 3. Create customer works and tested 
    ...
    Company testCompany = new Company(5, "Intel" , "abcd" , "intel@intel.com");
    Company testCompany1 = new Company(5, "Teva" , "1234" , "teva@teva.com");
