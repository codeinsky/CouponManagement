...
public interface CustomerDAO {
	 ...
	 * Abstract method receives Customer bean and creates new row in DataBase Customer table 
	 ...
	 * Abstract Method receives Customer bean. Search for existing Customer and removes it from 
	...
	/**
	 * Update customer.
	 * Abstract void method receives customer bean. Search for existing Customer in DataBase in Customer Table 
	 * and updates all attributes. 
	 * @param customer the customer
	 * @throws CouponSystemException the coupon system exception
	 */
	...
	/**
	 * Gets the customer.
	 * Abstract method, receives "long ID". Search for Customer with received ID and 
	 * returns Customer bean.
	 * @param id the id
	 * @return the customer
	 * @throws CouponSystemException the coupon system exception
	 */
	 ...
	 * Abstract method,  returns all Collection of All customers  
	...
	/**
	 * Login.
	 * Abstract method , receives String Customer Name and String Password. 
	 * Not used. 
	 * See dao.helperMethodsDAO.java LogIn; 
